...
export const mainMenu = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: "Shopify Accounting",        path: `${domain}/services/shopify-accounting-services` },
      { name: "Month-End Close",          path: `${domain}/services/month-end-closures` },
      { name: "KPI Reporting",             path: `${domain}/services/management-reporting` },
      { name: "Financial Reporting & Compliance",         path: `${domain}/services/financial-reporting` },
      ...
      { name: "NetSuite for eCommerce",      path: `${domain}/services/netsuite-for-ecommerce` },
    ],
  },
  {
    name: "Resources",
    ...
    submenu: [
      ...
      {
        name: "In-House vs Outsource Calculator",
        path: `${domain}/resources/true-cost-calculator`,
        // categoryMenu : [],
      }
...
export const footerMenuLinks = [
  ...
  },
  {
   ...
   {
    name: "Bench Alternative",
    path: `${domain}/bench-alternative`,
  },
];
export const footerServicesLinks = [
  { name: "Outsourced Bookkeeping Services",    path: `${domain}/blogs/in-house-accountant-vs-outsourcing-cost-comparison#cost-comparison` },
  { name: "Accounts Receivable",       path: `${domain}/services/accounts-receivable` },
  { name: "Accounts Payable",       path: `${domain}/services/accounts-payable` },
  { name: "Order Management",   path: `${domain}/services/order-management` },
  { name: "Inventory Accounting",       path: `${domain}/services/inventory-management` },
  ...
  { name: "Data Migration",     path: `${domain}/services/data-migration` },
  { name: "Staff Augmentation",  path: `${domain}/services/staff-augmentation` },
  { name: "Automation & Workflow",      path: `${domain}/services/staff-augmentation` },
  { name: "3PL Billing Audit",      path: `${domain}/services/3pl-billing-audit` },
  { name: "Shopify Accounting",      path: `${domain}/services/shopify-accounting-services` },
  { name: "NetSuite for E-Commerce",      path: `${domain}/services/netsuite-for-ecommerce` },
  { name: "E-Commerce Accounting",      path: `${domain}/services/ecommerce-accounting` },
