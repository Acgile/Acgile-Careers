    ...
    submenu: [
      {
        ...
        path: `${domain}/services/accounting-data-migration`,
      },
      {
        name: "Accounts Reconciliation Services",
        path: `${domain}/services/accounts-reconciliation-services`,
      },
      {
        name: "Financial Data Management",
        path: `${domain}/services/financial-data-management`,
      },
      {
        name: "Financial Management Services",
        path: `${domain}/services/financial-management-services`,
      },
      {
        name: "Financial Reporting Services",
        path: `${domain}/services/financial-reporting-services`,
      },
      {
        name: "Transaction Processing & Management Services",
        path: `${domain}/services/transaction-processing-management-services`,
      },
      {
        name: "Bookkeeping Services",
        path: `${domain}/services/bookkeeping`,
      },
      {
        name: "Quickbooks Services",
        path: `${domain}/services/quickbooks`,
      },
      {
        name: "NetSuite Services",
        path: `${domain}/services/netsuite`,
      },
    ],
  },
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        categoryMenu: [
          {
            name: "$2.3M Recovery (US Manufacturer)",
            slug: "2-3m-recovery-us-manufacturer",
          },
          {
            name: "AR Recovery ($1.48M)",
            slug: "accounts-receivable-recovery",
          },
          {
            name: "3PL Billing Recovery ($919K)",
            slug: "3pl-billing-recovery-audit",
          },
          {
            name: "BOL Dispute Defense ($668K)",
            slug: "box-netsuite-bol-dispute-defense",
          },
          {
            name: "Automotive Turnaround",
            slug: "automotive-ecommerce",
            extra: "pl-[20px]",
          },
          {
            name: "NetSuite Average Costing Cleanup",
            slug: "netsuite-average-costing-cutoff-rebuild",
            extra: "pl-[20px]",
          },
          {
            name: "EDI Monday Morning Automation",
            slug: "edi-monday-morning-automation",
            extra: "pl-[20px]",
          },
        ],
      },
      {
        name: "EDI Cost Calculator",
...
export const footerSocialLinks = [
  ...
  },
  {
    ...
    icon: "/icons/icon-twitter.webp",
  },
  {
    name: "Pinterest",
    link: "",
    icon: "/icons/icon-pinterest.webp",
  },
  {
    name: "Linkedin",
    link: "https://www.linkedin.com/company/acgile",
    icon: "/icons/icon-linkedin.webp",
  },
];
